...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int evr_select::wait_events(epoll_event* a_ev, int a_max_events, int a_timeout_msec)
{
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int evr_select::add_out(int a_fd, void* a_data)
{
	int l_fd = a_fd;
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int evr_select::add_in(int a_fd, void* a_data)
{
	int l_fd = a_fd;
