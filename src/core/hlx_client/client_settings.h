...
typedef struct client_settings_struct
{
        ...
        int32_t m_rate;
        hlx_client::request_mode_t m_request_mode;
        ...
        client_settings_struct() :
                ...
                m_run_time_s(-1),
                m_rate(-1),
                m_request_mode(hlx_client::REQUEST_MODE_ROUND_ROBIN),
                m_num_end_fetches(-1),
...
private:
        DISALLOW_COPY_AND_ASSIGN(client_settings_struct);

} client_settings_struct_t;

} //namespace ns_hlx {

#endif // #ifndef _CLIENT_SETTINGS_H
