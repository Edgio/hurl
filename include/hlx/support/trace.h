...
//: ----------------------------------------------------------------------------
#ifndef TRC_ERROR
#define TRC_ERROR(...)  TRC_PRINT(ns_hlx::TRC_LOG_LEVEL_ERROR, __VA_ARGS__)
#endif
#ifndef TRC_WARN
#define TRC_WARN(...)  TRC_PRINT(ns_hlx::TRC_LOG_LEVEL_WARN, __VA_ARGS__)
#endif
#ifndef TRC_DEBUG
#define TRC_DEBUG(...)  TRC_PRINT(ns_hlx::TRC_LOG_LEVEL_DEBUG, __VA_ARGS__)
#endif
#ifndef TRC_VERBOSE
...
#define TRC_OUTPUT(...) \
        do { \
        if(ns_hlx::g_trc_out_file)\
        {\
        fprintf(ns_hlx::g_trc_out_file, __VA_ARGS__); \
        fflush(ns_hlx::g_trc_out_file); \
        }\
        } while(0)
#endif
